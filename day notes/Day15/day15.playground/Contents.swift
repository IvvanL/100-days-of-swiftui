...
//////}
//////
//////var quote = "   The truth is rarely pure and never single   "
//////quote.trim()
//////
//////let lyrics = """
//////But i keep cruising
...
////
///////** PROTOCOL EXTENSIONS - let us add computed properties and methods to a whole protocol. so that any type conforming to the protocol gets access to them.
////
...
///** GUARD LET - unwraps options, similar to if let
...
///** NIL COALESCING OPERATOR- itll unwrap the optional, but if its empty itll let you provide a default value instead
...
///** OPTIONAL TRY? - wehn calling a function that might throw errors
